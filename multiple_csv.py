...
def export_csv(process):
    command = f'python3.8 -m tidaltailsim --nogui -v categorise_2galaxy_fromfile -f 5499 out/{process[0]}.pkl out_csv/{process[0]}.csv 1 0.1'
    os.system(command)


if __name__ == '__main__':
    print('Prepare exporting csv 2galaxy problem')
